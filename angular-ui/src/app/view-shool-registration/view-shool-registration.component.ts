...
@Component({
  selector: 'app-view-shool-registration',
  templateUrl: './view-shool-registration.component.html',
  styleUrls: ['./view-shool-registration.component.css']
})
export class ViewShoolRegistrationComponent implements OnInit {
